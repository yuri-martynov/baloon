module Atrapos.Screens.Game.Objects.Attack exposing (updateLocation, updateSettlement, updateSettlementCanceled, view)

import Svg exposing (..)
import Svg.Attributes exposing (..)
import Common.Dict as Dict
import Common.Types exposing (..)
import Atrapos.Screens.Game.Model as Game exposing (Attack(..), SettlementId)
