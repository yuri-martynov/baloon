...
var _user$project$Atrapos_Data_L39$model = {
	nodes: {
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 1.2, _1: 5.6},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 2, _1: 10},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 2.2, _1: 2},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 4, _1: 8},
						_1: {
		...
		if (_p28.ctor === 'Nothing') {
			return _elm_lang$core$Native_Utils.crashCase(
				'Atrapos.Game.Selection.Update',
				{
					...
					end: {line: 111, column: 28}
				},
				_p28)('nearestNode');
		} else {
			return (_elm_lang$core$Native_Utils.cmp(_p28._0._1, _user$project$Atrapos_Game_Selection_Update$selectRadius) < 0) ? _elm_lang$core$Maybe$Just(_p28._0._0) : _elm_lang$core$Maybe$Nothing;
		}
	});
...
var _user$project$Atrapos_Game_UI$levelCompleted = function (_p3) {
	var _p4 = _p3;
	return _p4.victory ? _user$project$Common_List$lst(
		A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('level-completed'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('score-label'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('score-value'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('45'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Atrapos_Game_Msg$Finished(_p4.levelId)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('next-level'),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$Atrapos_Game_UI$menu_ = function (menu) {
	return menu ? {
		ctor: '::',
...
var _user$project$Atrapos_Game_UI$ui = function (_p5) {
	var _p6 = _p5;
	return A2(
		_elm_lang$html$Html$div,
		{
		...
		},
		{
			...
			_1: A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Atrapos_Game_UI$menu_(_p6.menu),
				_user$project$Atrapos_Game_UI$levelCompleted(_p6))
		});
};
	...
	function (_p7, viewGame) {
						...
						_1: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'overdraft',
									_1: (!_p12) && (_elm_lang$core$Native_Utils.cmp(_p9, _p10) > 0)
								},
								_1: {
									ctor: '::',
									_0: {
		...
		return A2(
			...
			},
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$Atrapos_Game_UI$progress(_p11),
					_1: {
						ctor: '::',
...
var _user$project$Atrapos_Game_Update$update_ = F2(
	function (msg, _p0) {
		...
		switch (_p2.ctor) {
			...
			case 'Mouse':
				return A2(_user$project$Atrapos_Game_Selection_Update$update, _p2._0, _p3);
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_p3,
